          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<form method="post" action="index2.php?page=laporan&cari=ok">
							<table class="table table-striped">
								...
								<td>
									...
									<a href="index2.php?page=laporan" class="btn btn-success">
						...
						<form method="post" action="index2.php?page=laporan&hari=cek">
							<table class="table table-striped">
								<tr>
									<th>
										Pilih Hari
