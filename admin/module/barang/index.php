                  ...
                  <div class="col-lg-12 main-chart">
						...
						<?php
								...
								<div class='alert alert-warning'>
									...
									<span class='pull-right'><a href='index2.php?page=barang&stok=yes'>Cek Barang <i class='fa fa-angle-double-right'></i></a></span>
								</div>
								";	
							}
						?>
						...
						<a href="index2.php?page=barang&stok=yes" style="margin-right :0.5pc;" 
							class="btn btn-warning btn-md pull-right">
							<i class="fa fa-list"></i> Sortir Stok Kurang</a>
						<a href="index2.php?page=barang" style="margin-right :0.5pc;" 
								...
								?>
									<tr>
										...
										<td>
											...
											<?php }else{?>
											<a href="index2.php?page=barang/details&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-primary btn-xs">Details</button></a>
										
											<a href="index2.php?page=barang/edit&barang=<?php echo $isi['id_barang'];?>"><button class="btn btn-warning btn-xs">Edit</button></a>
