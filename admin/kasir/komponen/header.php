...
<div class="preloader-it">
    ...
    <div class="hk-wrapper hk-alt-nav">
        <!-- mulai bar navigasi-->
        <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar hk-navbar-alt bg-gradient-success">
            ...
            <a class="navbar-brand" href="index.php">
                <h5 class="brand-img d-inline-block align-top text-white"><?php echo $toko['nama_toko'] ?></h5>
            </a>
            <div class="collapse navbar-collapse" id="navbarCollapseAlt">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a href="index.php" class="nav-link text-white"><i class="zmdi zmdi-home"></i> Dashboard</a>
                    </li>
                    <li class="nav-item dropdown active">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-case-check"></i> Transaksi</a>
                    ...
                    <li class="nav-item dropdown active">
                        <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-collection-text"></i> Barang</a>
                        <div class="dropdown-menu" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                    ...
                    <li class="nav-item show-on-hover ">
                        <a href="laporan.php" class="nav-link active text-white"><i class="zmdi zmdi-assignment"></i> Laporan</a>
                    </li>
                </ul>
            </div>
                    ...
                    <a class="nav-link dropdown-toggle no-caret " href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span class="text-white"><?php echo $hasil_profil['nm_member'] ?><i class="text-white zmdi zmdi-chevron-down"></i></span>
                            </div>
                        </div>
                    </a>
