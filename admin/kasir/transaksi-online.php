...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header mb-1">
            ...
            <a class="btn btn-danger pull-right" href="fungsi/hapus/hapus.php?penjualan-online=jual"><i class="zmdi zmdi-delete"></i> Reset </a>
        </div>
                ...
                <div class="table-wrap">
                    <table id="tableDash1" class="table w-100 pb-30">
                        ...
                        <tbody>
                            <?php $total_bayar = 0;
                            $no = 1;
                            $hasil_penjualan = $lihat->penjualan_online(); ?>
                ...
                <div class="hk-row">
                        ...
                        <div class="card card-sm">
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <form action="transaksi-online.php?nota=yes#info" method="POST">
                    ...
                    <div class="col-md-4">
                        <div class="hk-pg-header mb-1" id="info">
                            ...
                            <!-- <a href="print-on.php?nm_member=<?php echo $_SESSION['admin']['nm_member']; ?>&bayar=<?php echo $bayar; ?>&kembali=<?php echo $hitung; ?>" target="_blank" class="d-flex text-secondary mr-15 disabled"></a> --><i class="zmdi zmdi-print zmdi-hc-2x"></i>
                        </div>
                        <div class="card card-sm">
                            <div class="card-body">
...
<script src="../../assets/vendors/bootstrap-input-spinner/src/bootstrap-input-spinner.js"></script>
<script src="../../assets/dist/js/inputspinner-data.js"></script>
